package win.downops.wallettracker.data.online.expense
...
import win.downops.wallettracker.data.online.communication.requests.ExpenseIdRequest
import win.downops.wallettracker.data.online.communication.requests.CreateExpenseRequest
import win.downops.wallettracker.data.online.communication.requests.EditExpenseRequest
import win.downops.wallettracker.data.online.communication.requests.ExpenseByCategoryIdRequest
...
class OnlineExpenseDAO(context: Context) : BaseOnlineDAO<Expense>(context), ExpenseRepository {
